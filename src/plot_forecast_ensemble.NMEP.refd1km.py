...
DomainRegions = {'Northeast':{'lat_c':40.,'lon_c':-72.,'deltalat':7.},'EasternUS':{'lat_c':40.,'lon_c':-76.,'deltalat':10.}}


def main():
    args = parse_args()
    os.makedirs(args.output_directory,exist_ok=True)
    data_dict = read_in_ensemble_variable(
        args.wrf_grib_files,
        {'shortName':'refd','level':1000}
    )
